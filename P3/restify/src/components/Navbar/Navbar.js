            ...
            <nav className="navbar  navbar-background fixed-top">
                <div className="container-fluid">
                    <Link to="/home" className="navbar-brand navbar-logo-color">
                        <img src={restLogo} height="28" className="d-inline-block align-text-top" alt=" "/> Restify
                    </Link>
                    <div className="ms-auto">
                        ...
                        <Link to="/" onClick={()=>deleteLogin()} className="btn  navbar-button-styling"> <img src={logoutSVG} alt=" "/>Logout</Link>
                    </div>
                </div>
            </nav>
